...
namespace WeaponSystem
{
    public class ThrowableWeapon : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (spriteTranform == null)
            {
                spriteTranform = transform.GetChild(0);
            }
        }
        ...
        private void Fly()
        {
            spriteTranform.rotation *= Quaternion.Euler(0, 0, Time.deltaTime * rotationSpeed * -movementDirection.x);
        }
